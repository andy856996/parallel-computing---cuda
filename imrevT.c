...
int main(int argc, char** argv)
{
 ...
 switch (argc){
 case 3 : NTHRDS=1; Rev='h'; break;
 case 4 : NTHRDS=1; Rev=tolower(argv[3][0]);
 break;
 case 5 : NTHRDS=atoi(argv[4]);
 Rev=tolower(argv[3][0]); break;
...
gettimeofday(&t, NULL); start = (double)t.tv_sec*1000000.0 + ((double)t.tv_usec);
if(NTHRDS >1){
